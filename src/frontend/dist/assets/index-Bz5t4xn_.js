...
const Usb = createLucideIcon("usb", __iconNode$3);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const finalLevel = (master, trim) => clamp(master + trim, 0, 79);
function Knob({
  value,
  min,
  max,
  ...
  const cx2 = svgSize / 2;
  const cy = svgSize / 2;
  const r2 = size === "lg" ? 44 : 32;
  const toRad = (deg) => (deg - 90) * Math.PI / 180;
  const arcPath = (start, end, radius) => {
    const x1 = cx2 + radius * Math.cos(toRad(start));
    const y1 = cy + radius * Math.sin(toRad(start));
    const x2 = cx2 + radius * Math.cos(toRad(end));
    const y2 = cy + radius * Math.sin(toRad(end));
    const large = end - start > 180 ? 1 : 0;
    return `M ${x1} ${y1} A ${radius} ${radius} 0 ${large} 1 ${x2} ${y2}`;
  };
  const indicatorX = cx2 + (r2 - 8) * Math.cos(toRad(angle));
  const indicatorY = cy + (r2 - 8) * Math.sin(toRad(angle));
  ...
  const fillOklch = color === "amber" ? "oklch(0.75 0.15 65)" : "oklch(0.80 0.12 195)";
  const numTicks = 11;
  const ticks = Array.from({ length: numTicks }, (_, i) => {
    const tickAngle = startAngle + i / (numTicks - 1) * (endAngle - startAngle);
    const rad = toRad(tickAngle);
    const isMajor = i === 0 || i === numTicks - 1 || i === Math.floor(numTicks / 2);
    const outerR = r2 + (size === "lg" ? 14 : 12);
    const innerR = r2 + (isMajor ? size === "lg" ? 7 : 6 : size === "lg" ? 10 : 9);
    const isLit = i / (numTicks - 1) <= pct;
    const tickKey = Math.round(tickAngle * 100);
    return {
      x1: cx2 + innerR * Math.cos(rad),
      y1: cy + innerR * Math.sin(rad),
      x2: cx2 + outerR * Math.cos(rad),
  ...
  const startValue = reactExports.useRef(value);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1 select-none", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative cursor-ns-resize", onMouseDown, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        role: "img",
        ...
        children: [
          ticks.map((tick) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "line",
            {
              x1: tick.x1,
              y1: tick.y1,
              x2: tick.x2,
              y2: tick.y2,
              stroke: tick.isLit ? fillColor : tick.isMajor ? "rgba(255,255,255,0.25)" : "rgba(255,255,255,0.10)",
              strokeWidth: tick.isMajor ? 2 : 1.2,
              strokeLinecap: "round",
              style: tick.isLit ? { filter: `drop-shadow(0 0 2px ${fillColor})` } : void 0
            },
            tick.tickKey
          )),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "path",
            {
              d: arcPath(startAngle, endAngle, r2),
              fill: "none",
              stroke: trackColor,
              strokeWidth: "5",
              strokeLinecap: "round"
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("radialGradient", { id: `kg-${label}`, cx: "38%", cy: "32%", r: "65%", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "#565e68" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "45%", stopColor: "#363d45" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "#1c2028" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("radialGradient", { id: `kg-shine-${label}`, cx: "38%", cy: "28%", r: "50%", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("filter", { id: `glow-${label}`, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: cx2, cy, r: r2 - 4, fill: `url(#kg-shine-${label})` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "circle",
            {
              cx: cx2,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          ...
          children: value > 0 && min < 0 ? `+${value}` : value
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
...
function ChannelFader({ channel, trim, master, onTrimChange }) {
  const level = finalLevel(master, trim);
  const levelPct = level / 79;
  const trackH = 130;
  const handleH = 16;
  const trimPct = (trim - -15) / 30;
  const handleTop = (1 - trimPct) * (trackH - handleH);
  const trimLabel = trim === 0 ? "0dB" : trim > 0 ? `+${trim}dB` : `${trim}dB`;
  const trimColor = trim > 0 ? "oklch(0.75 0.15 65)" : trim < 0 ? "oklch(0.65 0.15 25)" : "oklch(0.55 0.01 240)";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                [0.25, 0.5, 0.75].map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: {
          ...
          boxShadow: trim !== 0 ? `0 0 6px ${trimColor.replace("oklch", "oklch")} / 0.4)` : void 0,
          minWidth: "3.5ch",
          textAlign: "center"
        },
        children: trimLabel
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: { color: "oklch(0.80 0.12 195)" },
        children: String(level).padStart(2, "0")
      }
    )
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: {
        ...
        boxShadow: "inset 0 3px 12px rgba(0,0,0,0.95), inset 0 1px 3px rgba(0,0,0,0.8), inset 2px 0 6px rgba(0,0,0,0.4), inset -2px 0 6px rgba(0,0,0,0.4), 0 0 24px rgba(53,199,214,0.08), 0 0 1px rgba(53,199,214,0.15)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-full", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                ...
                textShadow: "0 0 8px oklch(0.75 0.15 65 / 0.7), 0 0 16px oklch(0.75 0.15 65 / 0.3)"
              },
              children: modeLabels[mode]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
            mute && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            standby && blink && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: "font-lcd text-[9px] px-1.5 py-0.5 rounded",
                style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              width: 1,
              height: 60,
              background: "linear-gradient(to bottom, transparent, oklch(0.28 0.04 160), transparent)"
            }
          }
        ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                ...
                textShadow: mute ? "none" : "0 0 14px oklch(0.82 0.13 195 / 0.8), 0 0 30px oklch(0.80 0.12 195 / 0.4), 0 0 50px oklch(0.80 0.12 195 / 0.15)",
                transition: "color 0.2s, text-shadow 0.2s",
                letterSpacing: "0.05em"
              },
              children: String(volume).padStart(2, "0")
            }
          )
        ] })
      ] })
...
function inputIcon(src) {
  if (src === "DVD") return /* @__PURE__ */ jsxRuntimeExports.jsx(Tv, { size: 10 });
  if (src === "USB") return /* @__PURE__ */ jsxRuntimeExports.jsx(Usb, { size: 10 });
  if (src.startsWith("FT:")) return /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { size: 10 });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Music, { size: 10 });
}
const ARDUINO_CODE = `/*
 * ====================================================================
...
function ArduinoCodePanel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-5xl mx-auto", "data-ocid": "arduino.panel", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "Ultra Digital 5.1 · ATmega328P · Copy and paste into Arduino IDE"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          style: {
            background: copied ? "oklch(0.38 0.12 145 / 0.9)" : "oklch(0.28 0.08 85 / 0.9)",
            color: copied ? "oklch(0.85 0.18 145)" : "oklch(0.82 0.12 85)",
            border: copied ? "1px solid oklch(0.55 0.18 145 / 0.7)" : "1px solid oklch(0.55 0.12 85 / 0.7)",
            boxShadow: copied ? "0 0 12px oklch(0.55 0.18 145 / 0.35)" : "0 0 8px oklch(0.55 0.12 85 / 0.25)"
          },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          ...
          boxShadow: "inset 0 2px 16px oklch(0.05 0.01 220 / 0.8), 0 4px 24px oklch(0.05 0.01 220 / 0.5)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "pre",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: ARDUINO_CODE })
            }
          )
        ]
      }
...
function PreviewPanel({ state }) {
  ...
  const channels = ["FL", "FR", "SL", "SR", "CENTER", "SUB"];
  const [copiedFull, setCopiedFull] = reactExports.useState(false);
  const [copiedIR, setCopiedIR] = reactExports.useState(false);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h1",
          {
            ...
            style: {
              ...
              textShadow: "0 1px 0 rgba(255,255,255,0.35), 0 2px 4px rgba(0,0,0,0.5), 0 -1px 0 rgba(0,0,0,0.3)"
            },
            children: "SYSTEM PREVIEW"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              padding: "3px",
              background: "linear-gradient(145deg, #4a525c 0%, #363c44 40%, #282d34 60%, #3a4048 100%)",
              borderRadius: 14
            },
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  background: "linear-gradient(180deg, #2e3440 0%, #262c34 60%, #22272e 100%)",
                  borderRadius: 12
                },
                children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-y-2 gap-x-4", children: [
                            ...
                            { label: "USB BOARD", value: usbBoard },
                            {
                              label: "MUTE",
                              value: mute ? "ON" : "OFF",
                              accent: mute ? "oklch(0.55 0.18 25)" : "oklch(0.60 0.12 145)"
                            },
                            {
                              label: "STANDBY",
                              value: standby ? "ON" : "OFF",
                              accent: standby ? "oklch(0.55 0.18 25)" : "oklch(0.60 0.12 145)"
                            }
                          ].map(({ label, value, accent }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "span",
                              {
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "span",
                              {
                                ...
                                style: {
                                  ...
                                  textShadow: accent ? `0 0 8px ${accent}` : "0 0 8px oklch(0.80 0.12 195 / 0.4)"
                                },
                                children: value
                              }
                            )
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              ...
                              style: {
                                ...
                                textShadow: "0 0 20px oklch(0.82 0.14 195 / 0.7), 0 0 40px oklch(0.82 0.14 195 / 0.3)",
                                fontVariantNumeric: "tabular-nums"
                              },
                              children: String(masterVolume).padStart(2, "0")
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                              ...
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "div",
                                {
                                  ...
                                  style: {
                                    ...
                                    background: "linear-gradient(to right, oklch(0.55 0.14 195), oklch(0.82 0.14 195))",
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "h2",
                          {
                            className: "font-brand text-[10px] tracking-[0.3em]",
                            style: { color: "oklch(0.50 0.01 240)" },
                            children: "CHANNEL LEVELS"
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: channels.map((ch, idx) => {
                                  ...
                                  "div",
                                  {
                                    ...
                                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                      "div",
                                      {
                                        ...
                                        style: {
                                          width: `${pct}%`,
                                          background: pct > 80 ? "linear-gradient(to right, oklch(0.55 0.15 65), oklch(0.75 0.18 25))" : "linear-gradient(to right, oklch(0.45 0.12 65), oklch(0.75 0.15 65))",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        ].map(({ label, value, min, max }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              ...
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "div",
                                {
                                  ...
                                  style: {
                                    ...
                                    background: "linear-gradient(to right, oklch(0.45 0.12 195), oklch(0.82 0.14 195))",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      style: {
                        ...
                        border: "1px solid oklch(0.22 0.04 220)",
                        boxShadow: "inset 0 1px 0 oklch(0.28 0.02 240 / 0.5), 0 4px 16px oklch(0.05 0.01 240 / 0.6)"
                      },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "button",
                            {
                              ...
                              style: {
                                background: copiedFull ? "oklch(0.25 0.08 170)" : "oklch(0.20 0.04 220)",
                                border: copiedFull ? "1px solid oklch(0.45 0.15 170)" : "1px solid oklch(0.30 0.04 220)",
                                color: copiedFull ? "oklch(0.75 0.15 170)" : "oklch(0.70 0.06 220)"
                              },
                              "data-ocid": "preview.firmware.button",
                              children: [
                                copiedFull ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 12 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { size: 12 }),
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "button",
                            {
                              ...
                              className: "flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-brand tracking-[0.15em] transition-all duration-200",
                              style: {
                                background: copiedIR ? "oklch(0.25 0.08 170)" : "oklch(0.20 0.04 220)",
                                border: copiedIR ? "1px solid oklch(0.45 0.15 170)" : "1px solid oklch(0.30 0.04 220)",
                                color: copiedIR ? "oklch(0.75 0.15 170)" : "oklch(0.70 0.06 220)"
                              },
                              "data-ocid": "preview.irmap.button",
                              children: [
                                copiedIR ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 12 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { size: 12 }),
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "div",
                                {
                                  ...
                                  style: {
                                    background: "linear-gradient(to bottom, transparent, oklch(0.09 0.02 240))"
                                  }
                                }
                              )
                            ]
                    ...
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          children: "◈ PREVIEW — READ ONLY — SETTINGS ARE LIVE ◈"
                        }
                      )
                    }
                  )
...
const SURROUND_MODES = ["STEREO", "MUSIC", "MOVIE", "GAME"];
const SURROUND_MODE_INFO = {
  STEREO: {
...
function App() {
  ...
  const setTrim = reactExports.useCallback((ch, v) => {
    setState((prev) => ({
      ...prev,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", "data-ocid": "app.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        ...
        children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: cn(
                  ...
                  standby ? "border-[oklch(0.40_0.06_65)] opacity-40" : "border-[oklch(0.75_0.15_65)]"
                ),
                style: {
                  background: standby ? "oklch(0.15 0.01 240)" : "radial-gradient(circle, oklch(0.25 0.08 65), oklch(0.14 0.03 65))"
                },
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Power,
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "nav",
            {
              ...
              "data-ocid": "nav.panel",
              children: NAV_TABS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  "data-ocid": "nav.tab",
                  ...
                  style: {
                    color: activeTab === tab ? "oklch(0.82 0.14 65)" : "oklch(0.50 0.01 240)"
                  },
                  children: [
                    tab,
                    activeTab === tab && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        style: {
                          background: "linear-gradient(to right, transparent, oklch(0.75 0.15 65), transparent)",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "main",
      {
        ...
        children: activeTab === "Arduino Code" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ArduinoCodePanel, {}) : activeTab === "Preview" ? /* @__PURE__ */ jsxRuntimeExports.jsx(PreviewPanel, { state }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
                ...
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-[1fr_auto_auto] gap-4 items-start", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            LcdDisplay,
                            {
                              mode: currentMode,
                                ...
                                INPUT_SOURCES.map((src) => {
                                  ...
                                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                    "button",
                                    {
                                      ...
                                      style: {
                                        color: isActive ? "oklch(0.82 0.14 65)" : "oklch(0.55 0.01 240)"
                                      },
                                      children: [
                                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                                          "span",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "panel-bevel rounded-xl p-4", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: "font-brand text-[10px] tracking-widest mb-4",
                              style: { color: "oklch(0.40 0.01 240)" },
                              children: "EQUALIZER & GAIN"
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-around flex-wrap gap-6", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              Knob,
                              {
                                value: bass,
                                ...
                                (b) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "button",
                                  {
                                    ...
                                    className: cn(
                                      ...
                                      usbBoard === b ? "btn-input-active" : "btn-input"
                                    ),
                                    style: {
                                      color: usbBoard === b ? "oklch(0.82 0.14 65)" : "oklch(0.50 0.01 240)"
                                    },
                                    children: b
                                  },
                                  b
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1.5", children: [
                              ...
                              SURROUND_MODES.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "button",
                                {
                                  type: "button",
                                  ...
                                  style: {
                                    background: surroundMode === m ? "oklch(0.16 0.06 195 / 0.5)" : "linear-gradient(180deg, #3a4048, #2e3440)",
                                    borderColor: surroundMode === m ? "oklch(0.65 0.12 195)" : "rgba(80,90,110,0.4)",
                                    color: surroundMode === m ? "oklch(0.85 0.12 195)" : "oklch(0.50 0.01 240)",
                                    boxShadow: surroundMode === m ? "0 0 10px oklch(0.80 0.12 195 / 0.35), inset 0 1px 0 rgba(255,255,255,0.08)" : "0 2px 4px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.07)"
                                  },
                                  children: m
                                },
                                m
                            ...
                            SURROUND_MODE_INFO[surroundMode] && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "div",
                              {
                                ...
                                children: [
                                  ...
                                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-x-3 gap-y-0.5", children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.55 0.06 195)" }, children: "BASS" }),
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: SURROUND_MODE_INFO[surroundMode].bass }),
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.55 0.06 195)" }, children: "TREBLE" }),
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: SURROUND_MODE_INFO[surroundMode].treble })
                                  ] }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "div",
                                    {
                                      ...
                                      children: SURROUND_MODE_INFO[surroundMode].result
                                    }
                                  )
                                ]
                              }
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1 mb-4", children: MODES.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "button",
                                {
                                  type: "button",
                                  "data-ocid": "mode.tab",
                                  ...
                                  style: {
                                    color: currentMode === m ? "oklch(0.10 0.01 240)" : "oklch(0.50 0.01 240)"
                                  },
                                  children: m
                                },
                                m
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "div",
                                {
                                  className: "font-brand text-[10px] tracking-widest mb-4",
                                  style: { color: "oklch(0.40 0.01 240)" },
                                  children: "CHANNEL TRIMS — FINAL LEVEL"
                                }
                              ),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-6 gap-4 justify-items-center", children: CHANNELS.map((ch) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                                ChannelFader,
                                {
                                  channel: ch,
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 grid grid-cols-6 gap-4", children: CHANNELS.map((ch) => {
                                      ...
                                      "div",
                                      {
                                        ...
                                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                          "div",
                                          {
                                            ...
                                            style: {
                                              width: `${lvl / 79 * 100}%`,
                                              background: lvl > 65 ? "oklch(0.65 0.18 25)" : "linear-gradient(to right, oklch(0.55 0.12 195), oklch(0.82 0.12 195))",
                                              boxShadow: "0 0 6px oklch(0.80 0.12 195 / 0.6)"
                                            }
                                          }
                                        )
                                      }
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                  "button",
                                  {
                                    ...
                                    style: {
                                      color: mute ? "oklch(0.10 0.01 240)" : "oklch(0.50 0.01 240)",
                                      minWidth: 80,
                                      boxShadow: mute ? "0 0 20px oklch(0.75 0.15 65 / 0.7), 0 0 40px oklch(0.75 0.15 65 / 0.3), inset 0 1px 0 rgba(255,255,255,0.3)" : void 0
                                    },
                                    children: [
                                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                                        mute ? /* @__PURE__ */ jsxRuntimeExports.jsx(VolumeX, { size: 16 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Volume2, { size: 16 }),
                                        "MUTE"
                                      ] }),
                                      mute && /* @__PURE__ */ jsxRuntimeExports.jsx(
                                        "span",
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                  "button",
                                  {
                                    ...
                                    style: {
                                      color: standby ? "oklch(0.10 0.01 240)" : "oklch(0.50 0.01 240)"
                                    },
                                    children: [
                                      /* @__PURE__ */ jsxRuntimeExports.jsx(Power, { size: 16 }),
                                      "STANDBY"
                                    ]
                                  }
                                ),
                                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                  "button",
                                  {
                                    ...
                                    style: {
                                      ...
                                      boxShadow: "0 0 8px oklch(0.80 0.12 195 / 0.2), 0 2px 4px rgba(0,0,0,0.4)"
                                    },
                                    children: [
